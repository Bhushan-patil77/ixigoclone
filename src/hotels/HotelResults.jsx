                            ...
                            <div className="flex-1 h-full flex flex-col justify-center px-15 py-10 xl:w-[400px]" >
                              <div className="flex items-center " >
                                <div className="flex flex-col">
                                  ...
                                  <input type="text" id='inputBox1' className=' w-full text-lg font-semibold outline-none bg-transparent' autoComplete='off' value={destination} onClick={() => { show("list1") }} onChange={(e) => { setDestination(e.target.value) }} onFocus={(e) => { e.target.select(); show("list1") }} />
                                </div>
                              </div>
                            </div>
                          </div>
